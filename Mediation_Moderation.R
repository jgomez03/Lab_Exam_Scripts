...
apa.cor.table(analytic.data, filename="Table 1_labquiz.doc", table.number=1)

glimpse(analytic.data)

###extract key columns, only keep complete cases
...
apa.reg.table(interaction.regression, filename="Table 2_labquiz.doc", table.number=2)
...
## 3D plot
library(MBESS)
intr.plot(b.0=49.2104, b.x=15.2537, b.z=9.5417, b.xz=6.0481,
